...
# Getting Started with PDF Generator API 3.1.1
...
![Version Check](https://apidocs.io/illustration/typescript?workspaceFolder=PDFGeneratorAPI311&step=versionCheck)
...
![Resolve Dependencies](https://apidocs.io/illustration/typescript?workspaceFolder=PDFGeneratorAPI311&workspaceName=pdf-generator-api-3-1-1-lib&step=resolveDependency)
...
- The created project manages its dependencies using its `package.json` file. In order to add a dependency on the *PDF Generator API 3.1.1Lib* client library, double click on the `package.json` file in the bar on the left and add the dependency to the package in it.

![Add PdfGeneratorApi311Lib Dependency](https://apidocs.io/illustration/typescript?workspaceFolder=PDFGeneratorAPI311&workspaceName=pdf-generator-api-3-1-1-lib&step=importDependency)
...
![Install PdfGeneratorApi311Lib Dependency](https://apidocs.io/illustration/typescript?step=installDependency)
...
* [Template Id](/doc/controllers/template-id.md)
* [Templates](/doc/controllers/templates.md)
* [Workspaces Workspace Id](/doc/controllers/workspaces-workspace-id.md)
